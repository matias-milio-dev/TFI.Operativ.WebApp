...
<body class="pagina-login">
    <form id="formRecuperar" runat="server">
        ...
        <div class="caja-login">
            ...
            <asp:HyperLink ID="lnkVolver" runat="server" NavigateUrl="~/Paginas/Usuarios/Login.aspx" CssClass="enlace-secundario" Text="<%$ Resources:Textos, EnlaceVolverIniciarSesion %>" />
