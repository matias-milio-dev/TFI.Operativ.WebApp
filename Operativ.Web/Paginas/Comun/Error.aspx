...
<asp:Content ID="ContentError" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <div class="tarjeta">
        ...
        <asp:HyperLink ID="lnkVolverLogin" runat="server" NavigateUrl="~/Paginas/Usuarios/Login.aspx" CssClass="enlace-secundario" meta:resourcekey="lnkVolverLogin" Text="Volver al inicio" />
    </div>
</asp:Content>
