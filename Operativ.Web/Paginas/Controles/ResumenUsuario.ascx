...
<div class="resumen-usuario">
    <asp:PlaceHolder ID="phBienvenida" runat="server">
    ...
    <div class="menu-usuario" id="menuUsuario">
        ...
        <div id="menuUsuarioDropdown" class="menu-usuario-dropdown">
            ...
            <asp:PlaceHolder ID="phOpcionesSesion" runat="server">
            ...
            <asp:PlaceHolder ID="phIniciarSesion" runat="server" Visible="false">
                <div class="menu-usuario-separador"></div>
                <asp:HyperLink runat="server" NavigateUrl="~/Paginas/Usuarios/Login.aspx" CssClass="menu-usuario-item menu-usuario-item-boton">
                    ...
                    <span class="menu-usuario-item-texto"><asp:Literal runat="server" Text="<%$ Resources:Textos, EnlaceIniciarSesion %>" /></span>
                </asp:HyperLink>
            </asp:PlaceHolder>
        </div>
    </div>
